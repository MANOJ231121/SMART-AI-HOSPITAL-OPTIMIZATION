  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-10" style={{ background: COLORS.bg }}>
      <Card className="w-full max-w-md p-8 text-center shadow-md relative">
        ...
        <p className="mt-2 text-sm" style={{ color: COLORS.sub }}>We'll ask a few simple questions by voice to register you and find the right doctor.</p>
        ...
        <div className="mt-8 flex flex-col gap-2.5">
          ...
          <GhostButton full onClick={() => go("landing")} icon={ChevronLeft}>Back to Home</GhostButton>
        </div>
...
function TokenComplete({ go, patientData, doctor, dept, lang = "hi" }) {
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "Inter, sans-serif", color: COLORS.text }}>
      ...
      {route === "token" && <TokenComplete go={go} patientData={patientData} doctor={selectedDoctor} dept={dept} lang={lang} />}
