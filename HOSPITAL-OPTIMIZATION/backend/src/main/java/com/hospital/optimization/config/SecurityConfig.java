...
import com.hospital.optimization.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Public AI Symptom Routing
                .requestMatchers("/api/ai/**").permitAll()

                // Public Patient Kiosk Registration & Token Status Tracking (SmartCare)
                ...
                // Public Department & Doctor directory for patient matching
                .requestMatchers("/api/departments/**").permitAll()
                .requestMatchers("/api/doctors/**").permitAll()

                // Protected Role-Based Management Endpoints
